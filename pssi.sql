...
--
-- Host: localhost:3306
-- Waktu pembuatan: 29 Des 2024 pada 12.11
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
(3, 'Jadwal Pertandingan', 'single_menu', 'https://bola.test/jadwal', 4, 0),
(4, 'Berita', 'single_menu', 'https://bola.test/semua_berita', 3, 0),
(5, 'Club', 'single_menu', 'https://bola.test/club', 5, 0),
(11, 'Profile', 'dropdown_menu', '#', 2, 0),
(12, 'Sejarah', 'sub_menu', 'https://bola.test/profile?id_pages=1', 1, 11),
(13, 'Visi Misi', 'sub_menu', 'https://bola.test/profile?id_pages=2', 2, 11),
(14, 'Struktur Organisasi', 'sub_menu', 'https://bola.test/profile?id_pages=3', 3, 11),
(15, 'Login', 'single_menu', 'https://bola.test/login', 6, 0);
...
--
-- Indeks untuk tabel `dokumen_pemain`
--
ALTER TABLE `dokumen_pemain`
  ADD PRIMARY KEY (`id_pemain`);

--
-- Indeks untuk tabel `jadwal_liga`
--
...
--
-- Indeks untuk tabel `peserta_liga`
--
ALTER TABLE `peserta_liga`
  ADD PRIMARY KEY (`id_peserta`);

--
-- Indeks untuk tabel `profile_admclub`
--
ALTER TABLE `profile_admclub`
  ADD PRIMARY KEY (`id_admclub`);

--
-- Indeks untuk tabel `profile_club`
--
ALTER TABLE `profile_club`
  ADD PRIMARY KEY (`id_club`);

--
-- Indeks untuk tabel `profile_pemain`
--
ALTER TABLE `profile_pemain`
  ADD PRIMARY KEY (`id_pemain`);

--
-- Indeks untuk tabel `profile_petugas`
--
...
--
ALTER TABLE `berita`
  MODIFY `id_berita` int NOT NULL AUTO_INCREMENT COMMENT 'id berita', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `berita_kategori`
--
ALTER TABLE `berita_kategori`
  MODIFY `id_kategori` int NOT NULL AUTO_INCREMENT COMMENT 'id kategori', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `dokumen_pemain`
--
ALTER TABLE `dokumen_pemain`
  MODIFY `id_pemain` int NOT NULL AUTO_INCREMENT COMMENT 'id dokumen pemain', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `jadwal_liga`
--
ALTER TABLE `jadwal_liga`
  MODIFY `id_jadwal` int NOT NULL AUTO_INCREMENT COMMENT 'id jadwal dan skor liga', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `liga`
--
ALTER TABLE `liga`
  MODIFY `id_liga` int NOT NULL AUTO_INCREMENT COMMENT 'id liga ', AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT untuk tabel `menu`
--
ALTER TABLE `menu`
  MODIFY `id_menu` int NOT NULL AUTO_INCREMENT COMMENT 'id menu', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `pages`
--
ALTER TABLE `pages`
  MODIFY `id_pages` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `peserta_liga`
--
ALTER TABLE `peserta_liga`
  MODIFY `id_peserta` int NOT NULL AUTO_INCREMENT COMMENT 'id peserta liga', AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `profile_admclub`
--
ALTER TABLE `profile_admclub`
  MODIFY `id_admclub` int NOT NULL AUTO_INCREMENT COMMENT 'id admin club', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `profile_club`
--
ALTER TABLE `profile_club`
  MODIFY `id_club` int NOT NULL AUTO_INCREMENT COMMENT 'id club', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT untuk tabel `profile_pemain`
--
ALTER TABLE `profile_pemain`
  MODIFY `id_pemain` int NOT NULL AUTO_INCREMENT COMMENT 'id pemain', AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `profile_petugas`
--
ALTER TABLE `profile_petugas`
  MODIFY `id_petugas` int NOT NULL AUTO_INCREMENT COMMENT 'id petugas', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `role`
--
ALTER TABLE `role`
  MODIFY `rid` int NOT NULL AUTO_INCREMENT COMMENT 'id role', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `users`
--
ALTER TABLE `users`
  MODIFY `id_user` int NOT NULL AUTO_INCREMENT COMMENT 'id of user', AUTO_INCREMENT=17;
COMMIT;
